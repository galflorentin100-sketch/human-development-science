...
VALID_STATES={"REVIEW_REQUIRED","DRAFT","PROPOSED","SUPPORTED","CONTRADICTED","UNCERTAIN","RETIRED"}
TERMINAL={"RETIRED"}
ALLOWED_TRANSITIONS={"REVIEW_REQUIRED":{"PROPOSED","SUPPORTED","CONTRADICTED","UNCERTAIN","RETIRED"},
